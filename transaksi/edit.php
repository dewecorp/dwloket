                                    ...
                                    <div class="modern-card-body">
                                        ...
                                        <div class="row">
                                            <?php foreach ($jenis_bayar_list as $jenis):
                                                ...
                                                $is_selected = ($jenis['id_bayar'] == $selected_id_bayar) ? 'selected' : '';
                                            ?>
                                            <div class="col-md-4 col-sm-6 mb-3">
                                                <div class="card jenis-bayar-card border-<?=$style['color']?> <?=$is_selected?>"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            jenisBayarCards.forEach(function(card) {
                card.addEventListener('click', function() {
                    ...
                    jenisInput.value = this.getAttribute('data-id-bayar');
